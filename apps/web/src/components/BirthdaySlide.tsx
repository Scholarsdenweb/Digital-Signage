...
const DATE: React.CSSProperties = { position: 'absolute', top: '10%', color: '#ffdd00', fontWeight: 600, letterSpacing: '0.56em', fontSize: 'min(5cqh, 4.6cqw)', textShadow: '0 0 18px rgba(255,221,0,.7),0 0 40px rgba(255,221,0,.35),0 2px 10px rgba(0,0,0,.65)', paddingLeft: '0.5em', animation: 'bd-down 1s ease-out both' };
