...
const DATE: React.CSSProperties = { position: 'absolute', top: '10%', color: '#22d3ee', fontWeight: 900, letterSpacing: '0.56em', fontSize: 'min(3.4cqh, 3cqw)', textShadow: '0 0 18px rgba(34,211,238,.75),0 0 40px rgba(34,211,238,.4),0 2px 10px rgba(0,0,0,.65)', paddingLeft: '0.5em', animation: 'bd-down 1s ease-out both' };
